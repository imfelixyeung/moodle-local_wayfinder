...
class grades extends command {
    ...
    public function check_access(): bool {
        ...
        return has_all_capabilities(['gradereport/grader:view', 'moodle/grade:viewall'], $context);
    }
    ...
    public function get_action(): ?action {
        ...
        return new redirect(new url('/grade/report/grader/index.php', ['id' => $context->instanceid]));
    }
}

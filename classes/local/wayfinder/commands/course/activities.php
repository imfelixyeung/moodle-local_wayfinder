...
class activities extends command {
    ...
    public function get_name(): lang_string {
        return new lang_string('activities');
    }
    ...
    public function check_access(): bool {
        ...
        return has_capability('moodle/course:viewoverview', $context);
    }
    ...
    public function get_action(): ?action {
        ...
        return new redirect(new url('/course/overview.php', ['id' => $context->instanceid]));
    }
}

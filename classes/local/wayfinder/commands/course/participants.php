 ...
 */
class participants extends command {
    #[\Override]
    public function get_name(): lang_string {
        return new lang_string('participants');
    }

    #[\Override]
    public function check_access(): bool {
        return $this->get_context_course() !== null;
    }
    ...
    public function get_action(): ?action {
        ...
        return new redirect(new url('/user/index.php', ['id' => $context->instanceid]));
    }
}
